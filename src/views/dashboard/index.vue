  ...
  <div class="dashboard-container">
    ...
    <el-card class="header-card">
      <div>
        <div class="fl headL">
          <div class="headImg">
            <img v-if="$store.getters.staffPhoto" :src="$store.getters.staffPhoto">
            <img v-else src="@/assets/common/qianhe.jpg">
          </div>
          <div class="headInfoTip">
            <p class="firstChild">{{ $t('navbar.hello') }}，{{ $store.getters.name }}，{{ $t('navbar.wishes') }}</p>
            <p class="lastChild">{{ $t('navbar.hello') }},{{ $store.getters.name }}，{{ $t('navbar.wishes') }}</p>
          </div>
        </div>
        <div class="fr" />
      </div>
